...
const fetchTransmissions = async (searchParams?: QueryParams): Promise<LovTransmissionsResponse> => {
...
export function useLovTransmissionsQuery(searchParams?: QueryParams, opts?: QueryOpts) {
  return useQuery({
...
function sortTransmissions(a: { value: string; label: string }, b: { value: string; label: string }) {
  if (!a.label || !b.label) {
    return 0
  }
...
export function getShortenTransmissionLabels(transmissionId: string, originalLabel: string) {
