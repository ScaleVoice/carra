...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, size, variant, orientation, children, loading, type = "button", ...props }, ref) => {
    return (
      <button
        ref={ref}
        className={twMerge("group", buttonVariants({ size, variant, orientation, loading }), className)}
        type={type}
        {...props}
      >
        {children}
