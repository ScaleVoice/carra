...
import { CallCustomerItem } from './CallCustomerTable.utils'
import { createColumnHelper } from '@tanstack/react-table'
import { serverOptions } from 'components/filters/serverId/ServerFilter'

export const useCallCustomerTableColumns = () => {
  const { t } = useTranslation(['callCustomer', 'common'])

  const { createSortableColumn } =
    useSortableColumns<CallCustomerItem>('callCustomer')
  const columnHelper = createColumnHelper<CallCustomerItem>()
  ...
  const columns = [
    createSortableColumn('adNo', {
      label: t('callCustomer:table_column_id'),
      cell: props => (
    ...
    createSortableColumn('carGrade', {
      label: t('callCustomer:table_column_car_grade'),
      cell: props => (
    ...
    createSortableColumn('makeId', {
      label: t('callCustomer:table_column_make'),
      cell: props => {
    ...
    createSortableColumn('modelId', {
      label: t('callCustomer:table_column_model'),
      cell: props => {
    ...
    createSortableColumn('yearOfMake', {
      label: t('callCustomer:table_column_year_of_make'),
      cell: props => {
    ...
    createSortableColumn('speedometerMileageKm', {
      label: t('callCustomer:table_column_mileage'),
      cell: props => {
    ...
    createSortableColumn('expectedPrice', {
      label: t('callCustomer:table_column_price'),
      cell: props => {
    ...
    createSortableColumn('fuelId', {
      label: t('callCustomer:table_column_fuel_type'),
      cell: props => {
    ...
    createSortableColumn('bodyId', {
      label: t('callCustomer:table_column_body'),
      cell: props => {
    ...
    columnHelper.accessor('seller.name', {
      header: () => (
        <TextBodyMedium size="small" color="night-l-100">
          {t('callCustomer:table_column_seller_name')}
        </TextBodyMedium>
      ),
      cell: props => (
        <TextBody size="small">
    ...
    createSortableColumn('transmissionId', {
      label: t('callCustomer:table_column_transmission'),
      cell: props => {
    ...
    createSortableColumn('rank', {
      label: t('callCustomer:table_column_rank'),
      cell: props => {
        return (
          <TextBody size="small">
    ...
    createSortableColumn('profit', {
      label: t('callCustomer:table_column_profit'),
      cell: props => {
    ...
    createSortableColumn('seller.type', {
      label: t('callCustomer:table_column_private'),
      cell: props => {
    ...
    createSortableColumn('serverId', {
      label: t('callCustomer:table_column_server_id'),
      cell: props => {
    ...
    createSortableColumn('downloadedAt', {
      label: t('callCustomer:table_column_downloaded_at'),
      cell: props => {
